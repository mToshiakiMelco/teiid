...
public class TestSocketServerConnection {
    ...
    @Test public void testLogonFailsWithMultipleHosts() throws Exception {
        ...
        Mockito.when(instanceFactory.getServerInstance((HostInfo)Mockito.any())).thenThrow(new SingleInstanceCommunicationException());
            ...
            public SocketServerInstance getServerInstance(HostInfo info)
                ...
                if (t != null) {
                    try {
                        ...
                        }).when(instance).send((Message)Mockito.any(), (ResultsReceiver<Object>)Mockito.any(), (Serializable)Mockito.any());
                    } catch (Exception e) {
