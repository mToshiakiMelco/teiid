...
public class TestAllResultsImpl {
    ...
    static ResultSetImpl helpTestBatching(StatementImpl statement, final int fetchSize, final int batchLength,
        ...
        when(dqp.processCursorRequest(ArgumentMatchers.eq(REQUEST_ID), ArgumentMatchers.anyInt(), ArgumentMatchers.eq(fetchSize))).thenAnswer(new Answer<ResultsFuture<ResultsMessage>>() {
            @Override
